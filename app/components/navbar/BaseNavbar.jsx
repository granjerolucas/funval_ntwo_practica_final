    ...
    <>
      <div className="flex items-center justify-between">
        ...
        <div className="md:hidden">
          <button
            type="button"
            className="hs-collapse-toggle relative size-9 flex justify-center items-center text-sm font-semibold rounded-lg border border-black/20 text-black hover:bg-white/10 focus:outline-none focus:bg-white/10 disabled:opacity-50 disabled:pointer-events-none"
      ...
      <div
        id="hs-base-header"
        className={`hs-collapse ${isOpen ? '' : 'hidden'} overflow-hidden transition-all duration-300 basis-full grow md:block`} 
